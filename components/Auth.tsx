  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-900">
      <div className="w-full max-w-md p-8 space-y-6 bg-gray-800 rounded-lg shadow-lg">
        <h1 className="text-3xl font-bold text-center text-red-500">Carrosserie Inspecteur</h1>
        <p className="text-center text-gray-400">Veuillez vous connecter pour continuer</p>
